...
PUBLIC int do_most_children(void)
{
    ...
    /* M2: i1 = children, i2 = pid (jak w kodzie testu) */
...
PUBLIC int do_most_descendants(void)
{
    ...
    for (i = 0; i < NR_PROCS; i++) {
        ...
        /* pomijamy init (PID 0) i proces podany przez użytkownika */
